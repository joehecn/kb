(function () {
  ...
  function biDivideModulo(x, y) {
    ...
    r = biShiftRight(r, lambda); // Fiddle with the signs and stuff to make sure that 0 <= r < y.
  ...
  function RSAKeyPair(encryptionExponent, decryptionExponent, modulus) {
    ...
    this.m = biFromHex(modulus); // We can do two bytes per digit, so
  ...
  function encryptedString(key, s) // Altered by Rob Saunders (rob@robsaunders.net). New routine pads the
